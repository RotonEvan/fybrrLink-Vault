...
void PrintCurrentPosition (Ptr<const MobilityModel> mobility) {
  ...
  // outfile << currentPos.x << " " <<currentPos.y << "\n";
}

/* Test function to print distance between two nodes given their MobilityModelHelpers */
void PrintDistanceBetween(Ptr<const MobilityModel> nodeA, uint32_t numA, Ptr<const MobilityModel> nodeB, uint32_t numB) {
