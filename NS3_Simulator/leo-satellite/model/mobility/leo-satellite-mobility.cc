 ...
 */
void  LeoSatelliteMobilityModel::DoSetPosition (const Vector &position)
{
...
Vector LeoSatelliteMobilityModel::DoGetPosition (void) const {
   double altitude = m_altitude;
...
Vector LeoSatelliteMobilityModel::DoGetVelocity (void) const {
